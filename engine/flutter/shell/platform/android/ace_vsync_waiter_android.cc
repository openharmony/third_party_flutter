...
std::unique_ptr<VsyncWaiter> VsyncWaiterAndroid::Create(flutter::TaskRunners task_runners)
{
    return std::make_unique<VsyncWaiterAndroid>(task_runners);
}
...
bool VsyncWaiterAndroid::Register(JNIEnv* env) {
  ...
  g_async_wait_for_vsync_method_ = env->GetStaticMethodID(
      g_vsync_waiter_class->obj(), "waitForVsync", "(J)V");

 ...
 public:
  ...
  class Delegate {
   public:
    ...
    //--------------------------------------------------------------------------
    /// @brief      ACE PC preview.
    ///
    virtual void OnSetIdleNotificationCallback(const IdleCallback& idleCallback) = 0;
  ...
  ///             waiter.
  ///
  virtual std::unique_ptr<VsyncWaiter> CreateVSyncWaiter(int32_t platform);
